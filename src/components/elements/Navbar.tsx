                ...
                <nav className="w-full flex justify-between gap-6 relative">
                    ...
                    <div className="min-w-max inline-flex relative">
                        <a href="/" className="relative flex items-center gap-3">
                            ...
                            <p className="inline-flex text-lg font-semibold text-heading-1">LOGO</p>
                        </a>
                    </div>
                    ...
                    >
                        ...
                        <div className="min-w-max flex items-center gap-x-3">
                            <button
                                onClick={toggleTheme}
                                className="outline-hidden flex relative text-heading-2 rounded-full p-2 lg:p-3 cursor-pointer ml-2">
                                {theme === "dark" ? (
                                    <svg
